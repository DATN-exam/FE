...
import { STUDENT_STATUS_LIST_OPTIONS } from '@/config/define'
import { StudentSearchFormProps } from '@/types/admin'
import { ChangeEvent } from 'react'

const SearchForm = (props: StudentSearchFormProps) => {
    ...
    <form className="space-y-4">
      <div className="grid grid-cols-1 gap-5 text-sm sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        ...
        <Select
          ...
          options={STUDENT_STATUS_LIST_OPTIONS}
